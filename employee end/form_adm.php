...
<font size=5>
<form action="adm_login.php" method="post" name="form" onSubmit="MM_validateForm('user_id','','R','pass','','R');return document.MM_returnValue" >
<table>
<tr><td>Admin ID </td><td> :<input type="text" name="adm_id" size="30"></td></tr>
...
<font size="+1"><center>New user? <a href ="admin_reg.php">Register here.</a>	</center></font>
