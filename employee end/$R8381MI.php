...
<section>
<div id="one">
<font style="font-size:21px"><b>Employee Login</b></font> <hr />
...
<font size="+1"><center>New user? <a href ="accordion2.php">Register here.</a>	</center></font>

</div>
<div id="two">
<font style="font-size:21px"><b>Administrator Login</b></font> <hr />

<font size=5>
<form action="login1.php" method="post" name="form" onSubmit="MM_validateForm('user_id','','R','pass','','R');return document.MM_returnValue" >
<table>
<tr><td>Admin ID </td><td> :<input type="text" name="user_id" size="30"></td></tr>
<tr><td>Password </td><td>:<input type="password" name ="pass" size="30"></td></tr></table>
<center><input type="submit" name="submit1" value="Submit">    <input type="reset" name="reset" value="Reset"></center>
</form></font><br>
<font size="+1"><center>New admin? <a href ="accordion2.php">Register here.</a>	</center></font>
